            ...
            <div ref={ref} className={`container mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 ${animationClasses}`}>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16">
                    <div className="flex-shrink-0 w-64 h-64 md:w-80 md:h-80 relative group">
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full transition-transform duration-500 group-hover:scale-105"></div>
                        <img
                            src="https://i.postimg.cc/t4PjPDZD/Profile.png"
                            alt="Professional Headshot of RAKESH RAVI"
                            className="relative w-full h-full object-cover rounded-full p-2 bg-white grayscale group-hover:grayscale-0 transition-all duration-500"
                        />
                    </div>
