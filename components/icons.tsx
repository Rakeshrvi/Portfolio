...
// This file contains SVG icons as React components.
// Using SVG components is more performant and flexible than font icons.
...
export const Building: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <rect x="4" y="4" width="16" height="16" rx="2" ry="2"></rect><line x1="8" y1="9" x2="8" y2="20"></line><line x1="12" y1="9" x2="12" y2="20"></line><line x1="16" y1="9" x2="16" y2="20"></line><line x1="4" y1="9" x2="20" y2="9"></line>
    </svg>
);
...
export const Cogs: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 20V14"/><path d="M12 8V2"/><path d="M4.93 19.07l4.24-4.24"/><path d="M14.83 9.17l4.24-4.24"/><path d="M19.07 19.07l-4.24-4.24"/><path d="M9.17 9.17L4.93 4.93"/><path d="M20 12H14"/><path d="M8 12H2"/><circle cx="12" cy="12" r="2"/><circle cx="5.5" cy="5.5" r="2.5"/><circle cx="18.5" cy="5.5" r="2.5"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/>
    </svg>
);
...
export const Rocket: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.1S6.1 14.86 4.5 16.5z"></path>
    <path d="M19 19c-1.5-1.5-2.08-3.5-3.23-4.41 1.34-1.42 1.3-3.61.23-5.02-1.37-1.74-3.63-2.65-5.42-2.35-1.84.33-3.48 1.48-4.46 3.03-1.05 1.67-.93 3.84.23 5.42.92 1.15 2.91 2.69 4.41 3.23.89.3 2.16.42 3.1.05.84-.37 1.98-.97 3.1-2.08-1.1-1.12-1.71-2.28-2.08-3.1z"></path>
  </svg>
);
...
export const Tractor: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M3 15h13.2a2 2 0 0 0 1.8-1l2-4H12V4H5a2 2 0 0 0-2 2v9Z"></path>
    <path d="M18 15h2a2 2 0 0 1 2 2v2h-4v-4Z"></path>
